...
| **Correo (Resend)** | ❌ **código listo, no conectado** (2026-09-17). Sin esto **el alta autoservicio no se completa sola**, no hay recuperación de contraseña ni aviso previo a una suspensión |
